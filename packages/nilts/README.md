...
| [fixed\_text\_scale\\_rich\_text](#fixed_text_scale_rich_text)                      | Checks usage of `textScaleFactor` in `RichText` constructor.                   |  Any versions nilts supports   | Practice |  Experimental  | ✅️ |
